...
const PHOTO_BASE = 'https://student-management-system-production-5527.up.railway.app';
                ...
                {students.map((st, i) => (
                  <tr key={st.id} style={{ background: i % 2 === 0 ? '#fff' : '#fafafa' }}>
                    <td style={{ padding: '12px 16px' }}>
                      {st.photo_url
                        ? <img src={`${PHOTO_BASE}${st.photo_url}`}
                    ...
                    <td style={{ padding: '12px 16px' }}><span style={badgeStyle(st.gender)}>{st.gender}</span></td>
                    <td style={{ padding: '12px 16px' }}>
            ...
            {students.map(st => (
              <div key={st.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                  ...
                  <span style={{ marginLeft: 'auto', ...badgeStyle(st.gender) }}>{st.gender}</span>
                </div>
